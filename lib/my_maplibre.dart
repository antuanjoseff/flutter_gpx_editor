            ...
            trackLoaded
                ? CircleAvatar(
                    ...
                    child: IconButton(
                      ...
                      tooltip: AppLocalizations.of(context)!.tooltipEditTrack,
                      onPressed: () async {
                        editMode = !editMode;
                        setState(() {});
                      },
          ...
          AnimatedSize(
            ...
            child: Column(children: [
              ...
              CircleAvatar(
                ...
                backgroundColor: editTools['move']! ? backgroundActive : white,
                child: IconButton(
              ...
              CircleAvatar(
                  ...
                  child: IconButton(
                    tooltip: AppLocalizations.of(context)!.tooltipoAddWaypoint,
                    icon: SvgIcon(
