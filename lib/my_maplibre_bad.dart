        ...
        if (editTools['add']!) ...[
          GestureDetector(
            onTap: () async {
              ...
              var (distance, nodeIdx, candidate) =
                  track!.getCandidateNode(center);

              await mapController!
                  .animateCamera(
                CameraUpdate.newLatLng(candidate),
                              ...
                              Row(
                                ...
                                children: <Widget>[
                                  ...
                                  ElevatedButton(
                                    ...
                                    onPressed: () async {
                                      bool status = await addNode(
                                          distance, nodeIdx, candidate);
                                      if (status) {
